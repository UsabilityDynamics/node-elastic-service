...
function ElasticClient( options ) {
  ...
  Object.defineProperties( this, {
    ...
    settings: {
      value: ElasticClient.utilities.defaults( options || {}, ElasticClient._defaults || {} ),
      enumerable: false,
      writable: true
    },
    client: {
...
Object.defineProperties( ElasticClient.prototype, {
  ...
  set: {
    ...
    value: function set( key, value ) {
      ...
      // Create Container
      this.settings = ElasticClient.utilities.defaults( this.settings, ElasticClient._defaults );
      ...
      if( 'object' === typeof key ) {
        ElasticClient.utilities.extend( this.settings, key );
      }
